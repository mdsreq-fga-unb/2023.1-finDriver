...
const config = {
  ...
  organizationName: '2023.1-finDriver', // Usually your GitHub org/user name.
  projectName: 'FinDriver', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/mdsreq-fga-unb/2023.1-finDriver',
            label: 'GitHub',
            position: 'right',
          },
        ],
